...
| Policy.ReadWrite.AuthenticationMethod +  UserAuthenticationMethod.ReadWrite.All | PE (admin user), Defence Evasion (bypass MFA), Persistence | Configure Temporary Access Pass for a user                   | [Set-AAAUserAuthTempPass](https://github.com/Hagrid29/AbuseAzureAPIPermissions#configure-temporary-access-pass-pe-to-admin-user-bypass-mfa)                  |
...
| Mail.Read                                               | Data Collection                                           | Read content of emails                                       | [Get-AAAEmails](https://github.com/Hagrid29/AbuseAzureAPIPermissions#email)                       |
